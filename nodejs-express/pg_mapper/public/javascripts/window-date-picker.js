  ...
  function () {
    ...
    _createClass(WindowDatePicker, [{
      ...
      value: function setPosition() {
        ...
        if (x >= w && _x > 0) {
          this.el.style.left = "88%";//rect.left + rect.width - ow + 'px';
        } else {
          this.el.style.left = "88%"; //rect.left + 'px';
        }

        if (y >= h && _y > 0) {
          this.el.style.top = "-25%"; //rect.top - oh + 'px';
        } else {
          this.el.style.top = "-25%"; //rect.top + rect.height + 'px';
        }
      }
      /**
